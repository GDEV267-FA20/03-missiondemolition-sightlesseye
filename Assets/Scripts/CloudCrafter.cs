...
public class CloudCrafter : MonoBehaviour
{
    ...
    public float cloudScaleMin = .2f;     // Min scale of each cloud
    public float cloudScaleMax = 4f;     // Max scale of each cloud
    public float cloudSpeedMult = 0.6f; // Adjusts speed of clouds
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < numClouds; i++)
        {
            ...
            int prefabNum = Random.Range(0, 5);
            // Make an instance
